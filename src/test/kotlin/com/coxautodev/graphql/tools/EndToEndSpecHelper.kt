...
fun createSchema() = SchemaParser.newParser()
        ...
        .resolvers(Query(), Mutation(), Subscription(), ItemResolver(), UnusedRootResolver(), UnusedResolver(), FileUploadResolver())
...
type Mutation {
    ...
    echoFile(filePart: Upload!): String
}
...
class FileUploadResolver: GraphQLMutationResolver{
    fun echoFile(filePart: Part): String = String(filePart.inputStream.readBytes())
}
